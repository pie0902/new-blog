...
* 선택한 일정 삭제 기능
    ...
    * 선택한 일정을 삭제할 수 있습니다.
        ...
        * 선택한 일정의 `비밀번호`와 요청할 때 함께 보낸 `비밀번호`가 일치할 경우에만 삭제가 가능합니다. Use Case Diagram
            

### Use Case Diagram

![](https://blog.kakaocdn.net/dn/dyeT6u/btsDQ8yVDAK/qyn03kDACbDBbqBVnsUq81/img.png)
...
![](https://blog.kakaocdn.net/dn/b1iYCT/btsDT10g5IZ/wMM8pwEGzMp6pH5xnfXRZK/img.png)
